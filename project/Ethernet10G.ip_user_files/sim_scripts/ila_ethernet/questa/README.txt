...
#
# Generated by export_simulation on Thu Mar 28 12:25:27 +0300 2024
#
################################################################################
...
'-reset_run' switch to the './ila_ethernet.sh' script.

./ila_ethernet.sh -reset_run
...
./ila_ethernet.sh -noclean_files

For more information on the script, please type './ila_ethernet.sh -help'.
