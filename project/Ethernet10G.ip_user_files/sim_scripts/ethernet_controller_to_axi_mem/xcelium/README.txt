...
#
# Generated by export_simulation on Sun Mar 03 13:11:46 +0300 2024
#
################################################################################
...
./ethernet_controller_to_axi_mem.sh
...
'-reset_run' switch to the './ethernet_controller_to_axi_mem.sh' script.

./ethernet_controller_to_axi_mem.sh -reset_run
...
./ethernet_controller_to_axi_mem.sh -noclean_files

For more information on the script, please type './ethernet_controller_to_axi_mem.sh -help'.
