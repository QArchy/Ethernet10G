...
#
# Generated by export_simulation on Mon Mar 11 09:13:16 +0300 2024
#
################################################################################
...
'-reset_run' switch to the './fifo_dual_clk_64.sh' script.

./fifo_dual_clk_64.sh -reset_run
...
./fifo_dual_clk_64.sh -noclean_files

For more information on the script, please type './fifo_dual_clk_64.sh -help'.
